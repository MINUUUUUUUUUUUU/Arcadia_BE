package profit.arcadia.auth.oauth2.handler;

import org.springframework.stereotype.Service;
import profit.arcadia.user.domain.User;
import profit.arcadia.auth.jwt.TokenProvider;
import profit.arcadia.auth.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import profit.arcadia.auth.oauth2.service.OAuth2UserPrincipal;
import profit.arcadia.auth.oauth2.user.OAuth2Provider;
import profit.arcadia.auth.oauth2.user.OAuth2UserUnlinkManager;
import profit.arcadia.auth.oauth2.util.CookieUtils;
...
import static profit.arcadia.auth.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.MODE_PARAM_COOKIE_NAME;
import static profit.arcadia.auth.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response,
        ...
        if ("arcadia".equalsIgnoreCase(mode)) {
