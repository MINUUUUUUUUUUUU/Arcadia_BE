...
import profit.arcadia.auth.config.JwtAuthenticationFilter;
import profit.arcadia.auth.jwt.TokenProvider;
import profit.arcadia.auth.oauth2.service.CustomOAuth2UserService;
import profit.arcadia.auth.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import profit.arcadia.auth.oauth2.handler.OAuth2AuthenticationFailureHandler;
import profit.arcadia.auth.oauth2.handler.OAuth2AuthenticationSuccessHandler;
